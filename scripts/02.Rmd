...
Pronóstico del clima (Cualitativa)
Clase: Politómicas.
Escala: Ordinal.  

Municipio de medición (Cualitativa)
Clase: Politómicas.
Escala: Nominal.  

Temperatura medida en grados centígrados. (Cuantitativa)
Clase: Discreta
Escala: Intervalo.  

Velocidad del viento medida en mph (Cuantitativa)
Clase: Continua
Escala: Razon.  
