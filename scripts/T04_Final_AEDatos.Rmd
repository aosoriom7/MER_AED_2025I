...
head(arbolPrediccion_01, 50)
head(wineQ_valdtn[["quality"]], 50)
#qualityPr
```

Con base en los resultados de la predicción y comparado con datos del conjunto de validacion, se evidencian diferencias entre los primeros 10 registros de ambos conjuntos.
...
De los resultados obtenidos, para el caso del parametro de calidad 5, se puede observar en la imagen para la matriz de confusion que:
